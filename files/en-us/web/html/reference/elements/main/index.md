...
The content of a `<main>` element should be unique to the document. Content that is repeated across a set of documents or document sections (such as sidebars, navigation links, copyright information, site logos, and search forms) shouldn't be included unless it takes part of the main function of the page.
